...
@section('reservation')
      <div id="condition">
        ...
        <p>  NOMBRES DE PLACES MAXIMUM : <strong> 30 </strong> <p>
          <i> Famille </i> : 1 semaine par mois <p>
            <i> École </i>  : 1 classe par jour -
            ...
            <div id="align">
              ...
              <p>
                <select name="famille" size="1" id="liste">
                  <option id="liste">École
                    <option id="liste">Éphad
                      <option id="liste">Tout seul 
                      </select>
                    </p>
                    ...
                    <label for="mail" id="titre"> Mail   </label>
                    <p>
